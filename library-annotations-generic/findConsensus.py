...
parser.add_argument('-r1', '-read1', required=True, help="dictionary of barcodes to read1 reads", action='store', dest='R1_dict')
parser.add_argument('-r2', '-read2', required=True, help="dictionary of barcodes to read2 reads", action='store', dest='R2_dict')
parser.add_argument('-o', '-out', required=True, help="path to save output files under", action='store', dest='out')
...
parser.add_argument('-flength', required=False, default=None, help="length of read1 read to use in finding consensus (default=None)", action='store', dest='read1_length') #TODO: default used to be 50
parser.add_argument('-rlength', required=False, default=None, help="length of read2 read to use in finding consensus (default=None)", action='store', dest='read2_length')
...
# Returns the read2 complement DNA sequence.
...
results = open(args.out + str(segment) + "-" + str(total_segments) + '_consensus_queries.fasta', 'w')

flength = args.read1_length
rlength = args.read2_length
